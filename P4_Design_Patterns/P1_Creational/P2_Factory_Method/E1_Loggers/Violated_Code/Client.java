package P4_Design_Patterns.P1_Creational.P2_Factory_Method.E1_Loggers.Violated_Code;

import P4_Design_Patterns.P1_Creational.P2_Factory_Method.E1_Loggers.Violated_Code.logger.ILogger;
import P4_Design_Patterns.P1_Creational.P2_Factory_Method.E1_Loggers.Violated_Code.logger.impl.DebugLogger;
import P4_Design_Patterns.P1_Creational.P2_Factory_Method.E1_Loggers.Violated_Code.logger.impl.ErrorLogger;
import P4_Design_Patterns.P1_Creational.P2_Factory_Method.E1_Loggers.Violated_Code.logger.impl.InfoLogger;
import P4_Design_Patterns.P1_Creational.P2_Factory_Method.E1_Loggers.Violated_Code.models.LogLevel;
